...
val moleSI: Double = 6.022140857e23  // [unitless] Avogadro's number
val Nav: Double = moleSI
//me_si = 9.10938356e-31  # [kg] electron rest mass
val eSI: Double = 1.6021766208e-19 // [C] elementary charge
//
//# Distance units
//meter_si = 1.0
//bohr_si = (
...
val angstromSI: Double = 1e-10 // [m] Angstrom
val centimeterSI: Double = 1e-2 // [m] centimeter
//micrometer_si = 1e-6  # [m] micrometer (micron)
//nanometer_si = 1e-9  # [m] nanometer

// Mass units
//kilogram_si = 1.0
val gramPerMoleSI: Double = 1e-3 / Nav  // [kg] gram per mole i.e. amu
val amuSI: Double = gramPerMoleSI
val gramSI: Double = 1e-3 // [kg] gram
...
val picosecondSI: Double = 1e-12 // [s] picosecond
val femtosecondSI: Double = 1e-15 // [s] femtosecond
//
//# Density units
...
// Energy/torque units
//joule_si = 1.0
val kcalSI: Double = 4184.0 // [J] kilocalorie (heat energy involved in warming up one kilogram of
//# water by one degree Kelvin)
val evSI = 1.6021766208e-19 // [J] electron volt (amount of energy gained or lost by the
...
val kcalPerMoleSI: Double = kcalSI / Nav // [J] kcal/mole
//erg_si = 1e-7  # [J] erg
...
val angstromPerFemtosecondSI: Double = angstromSI / femtosecondSI // [m/s] Angstrom/femtosecond
val angstromPerPicosecondSI = angstromSI / picosecondSI // [m/s] Angstrom/picosecond
...
// Force units
//newton_si = 1.0
val kcalPerMoleAngstromSI: Double = kcalPerMoleSI / angstromSI // [N] kcal/(mole*Angstrom)
val evPerAngstromSI: Double = evSI / angstromSI // [N] eV/Angstrom
...
// Temperature units
val kelvinSI: Double = 1.0

// Pressure units
//pascal_si = 1.0
val atmosphereSI: Double = 101325.0 // [Pa] standard atmosphere (NIST value)
val barSi: Double = 1e5 // [Pa] bar
...
// Viscosity units
val poiseSI: Double = 0.1 // [Pa*s] Poise
...
// Charge units
//coulomb_si = 1.0
val echargeSI: Double = eSI // [C] electron charge unit
//statcoulomb_si = (
//e_si / 4.8032044e-10
...
// Dipole units
//coulomb_meter_si = 1
val electronAngstromSI: Double = echargeSI * angstromSI // [C*m] electron*angstrom
...
//volt_si = 1.0
//volt_per_meter_si = 1
val voltPerAngstromSI = 1.0 / angstromSI // [V/m] volt/angstrom
